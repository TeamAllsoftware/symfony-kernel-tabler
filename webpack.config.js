...
// the project directory where compiled assets will be stored
    ...
    .setPublicPath('/bundles/symfony_kernel_tabler/')

    // make sure the manifest prefix matches the structure in the real application
    .setManifestKeyPrefix('bundles/symfony_kernel_tabler/')
    ...
    .addEntry('symfony_kernel_tabler', './assets/symfony_kernel_tabler.js')
